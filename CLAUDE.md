...
- A synthetic HL7 message generator (`app/generators/`) covering all 9 combinations above, with realistic field-level randomization, selectable from a UI dropdown or `/api/generate`.
